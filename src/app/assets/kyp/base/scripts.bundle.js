...
var KTLayout_shelf = function() {
    var body;

    var header;
    var headerMenu_shelf;
    ...
    var initHeader_shelf = function() {
        ...
        var options = {
            ...
            offset: {
                desktop: parseInt(KTUtil.css(headerEl, 'height')) - 40
            },
            minimize: {
                mobile: false,
                desktop: {
    ...
    // Header Menu
    var initHeaderMenu_shelf = function() {
        ...
        headerMenu_shelf = new KTMenu('kt_header_menu', {
            submenu: {
                desktop: 'dropdown',
                tablet: 'accordion',
                mobile: 'accordion'
    ...
    // Header Topbar
    var initHeaderTopbar_shelf = function() {
        ...
        if (KTUtil.attr(menu, 'data-ktmenu-scroll') === '1') {
            scroll = {
                height: function() {
                    ...
                    if (KTUtil.isInResponsiveRange('desktop')) {
                        height = parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight('kt_header', false)) - parseInt(KTUtil.actualHeight('kt_footer', false)+50);
    ...
    return {
        ...
        initHeader_sh: function() {
            initHeader_shelf();
            initHeaderMenu_shelf();
            initHeaderTopbar_shelf();
            initScrolltop();
        },
